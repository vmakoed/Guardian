...
void FileManager::writeToDrive(char driveLetter, char *fileName, char *name, char *key, char *inHex)
{
...
bool FileManager::extractInfo(char driveLetter, char *fileName, char *name, char *key, char *inHex)
{
...
bool FileManager::extractFromBuffer(char *buffer, char *name, char *key, char *inHex)
{
...
wchar_t* FileManager::createPath(char driveLetter, char *fileName)
{
...
char* FileManager::createBuffer(char *name, char *key, char *inHex)
{
    char nameInput[] = "#NAME#";
    char keyInput[] = "#KEY#";
...
void FileManager::deleteFile(char driveLetter, char *fileName)
{
